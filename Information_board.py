...
class Information_board:
    def __init__(self, screen, read_max_score):
        self.screen = screen
        ...
        self.text_Max_Score = self.font.render(f'Max Score:', True, self.color)
    ...
    def draw_board(self, fps, lives, level, score):
        ...
        # отрисовка счётчика
        self.surface.blit(self.text_Max_Score, (0, 0))
        self.surface.blit(self.max_score, (0, self.text_Max_Score.get_size()[1]))
        self.surface.blit(self.text_Score, (0, self.text_Max_Score.get_size()[1] + self.max_score.get_size()[1]))
        self.surface.blit(text_score, (0, text_score.get_size()[1] + self.text_Max_Score.get_size()[1] + self.max_score.get_size()[1]))
        # отрисовка жизней
